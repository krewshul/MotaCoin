...
unsigned int nTargetSpacing = 4.3 * 60; // 4 minute 20 sec
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (pindexBest->nHeight > 1 && pindexBest->nHeight <= 2) //premine
    {
      nSubsidy = 53100000 * COIN;    
                                    ...
                                    //  Dev Fund:                      11.5 million MotaCoins
                                    //  ICO:                           30 million MotaCoins
                                    //  Airdrop:                       1.6 million MotaCoins
                                    //  Premine Total: 53,100,000
                                    //  Proof of work:                46,900,000 MotaCoins
                                    //  Total = 53,100,000  + 46,900,000 (POW) = 100,000,000 MotaCoins 
    ...
    else if(pindexBest->nHeight < 61742)    //     
    {
        nSubsidy = 75 * COIN;
    }
    else if(pindexBest->nHeight < 123484)   //    
    {
        nSubsidy = 66 * COIN;
    }
    else if(pindexBest->nHeight < 185226)   //    
    {
        nSubsidy = 55 * COIN;
    }
    else if(pindexBest->nHeight < 246968)   //    
    {
        nSubsidy = 50 * COIN;
    }
    else if(pindexBest->nHeight < 308710)   //   
    {
        nSubsidy = 47 * COIN;
    }
    else if(pindexBest->nHeight < 370452)   //    
    {
        nSubsidy = 44 * COIN;
    }
    else if(pindexBest->nHeight < 432194)   //    
    {
        nSubsidy = 41 * COIN;
    }
    else if(pindexBest->nHeight < 493936)   //   
    {
        nSubsidy = 39 * COIN;
    }
    else if(pindexBest->nHeight < 555678)   //    
    {
        nSubsidy = 37 * COIN;
    }
    else if(pindexBest->nHeight < 617420)   //    
    {
        nSubsidy = 35 * COIN;
    }
    else if(pindexBest->nHeight < 679162)   //    
    {
        nSubsidy = 33 * COIN;
    }
    else if(pindexBest->nHeight < 740904)   //    
    {
        nSubsidy = 32 * COIN;
    }
    else if(pindexBest->nHeight < 802646)   //    
    {
        nSubsidy = 31 * COIN;
    }
    else if(pindexBest->nHeight < 864388)   //   
    {
        nSubsidy = 30 * COIN;
    }
    else if(pindexBest->nHeight < 926130)   //   
    {
        nSubsidy = 29 * COIN;
    }
    else if(pindexBest->nHeight < 987872)   // 
    {
        nSubsidy = 28 * COIN;
    }
    else if(pindexBest->nHeight < 1049614)   //     
    {
        nSubsidy = 27 * COIN;
    }
    else if(pindexBest->nHeight < 1111356)   //    
    {
        nSubsidy = 26 * COIN;
    }
else if(pindexBest->nHeight < 1173098)   //    
    {
        nSubsidy = 25 * COIN;
    }
    else if(pindexBest->nHeight < 1234526)   //  
    {
        nSubsidy = 21.81 * COIN;
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, unsigned int nTime, int64_t nFees, int64_t nValueIn, uint256 prevHash)
{
	...
	if (inputcoins >= 99000000) // effectively shut off
	{
		if(rand1 <= 5)
...
static const int nTargetTimespan = 60 * 60; // 1 hr 
static const int nTargetSpacingWorkMax = 3 * nStakeTargetSpacing; // ~9 minutes
//
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    printf("vtxSize=%" PRId64 " Blocktime=%" PRId64 " nTime=% " PRId64 " clockDriftnTime=%" PRId64 " delta=%" PRId64 "\n", 
      vtx.size(),
      GetBlockTime(), 
      (int64_t)vtx[0].nTime, 
      GetClockDrift((int64_t)vtx[0].nTime),
      GetBlockTime() - (int64_t)vtx[0].nTime
    );            
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        if (!fAllowNew)
            return false;
/*            
            block.GetHash() == 00000fea25f87416682baa54946a1d156909d0959588eb573a0ae16a64230c61
            block.hashMerkleRoot == b3d8b0c93a5a36fc81b2cdc8a5ca2adb781f4d22530cd4671cf2e2c8181754d6
            block.nTime = 1521404888 
            block.nNonce = 145590             
*/            
        const char* pszTimestamp = "POTUS Tweets:'And yet, there is NO COLLUSION!'";
        CTransaction txNew;
        txNew.nTime = 1521404888; // Sunday, March 18, 2018 12:00:00 PM GMT-07:00
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1521404888; // Sunday, March 18, 2018 12:00:00 PM GMT-07:00
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("b3d8b0c93a5a36fc81b2cdc8a5ca2adb781f4d22530cd4671cf2e2c8181754d6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x30, 0x4A, 0x30, 0x4A };
